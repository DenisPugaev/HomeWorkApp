...
import static ru.geekbrains.lesson8.GameSnake.CANVAS_HEIGHT;
import static ru.geekbrains.lesson8.GameSnake.CANVAS_WIDTH;
    ...
    public void add() {
        ...
        do {
            ...
            y = random.nextInt(CANVAS_HEIGHT);
                ...
                || isPoison(x, y)
                || food.isFood(x, y));
        poison.removeAll(Collections.unmodifiableList(poison));
